...
namespace ego_planner
{
  ...
  void EGOPlannerManager::initPlanModules(ros::NodeHandle &nh, PlanningVisualization::Ptr vis)
  {
    ...
    nh.param("a_star/pool_size_x", astar_pool_size_x, 200);
    nh.param("a_star/pool_size_y", astar_pool_size_y, 200);
    nh.param("a_star/pool_size_z", astar_pool_size_z, 80);
    bspline_optimizer_rebound_->a_star_->initGridMap(
        grid_map_, Eigen::Vector3i(astar_pool_size_x, astar_pool_size_y, astar_pool_size_z));
